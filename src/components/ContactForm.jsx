...
import { X, Loader2, CheckCircle, MessageCircle, User, Mail, Phone, BookOpen, FileText, MessageSquare, Sparkles } from 'lucide-react'
import { sendCourseInquiryEmail } from '../utils/emailService'
import { openWhatsApp } from '../utils/whatsapp'

const ContactForm = ({ isOpen, onClose, defaultMessage = '' }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        setSubmitMessage({
          type: 'success',
          text: 'Thank you! We have received your inquiry. We will contact you soon.'
        })
        setFormData({ name: '', email: '', phone: '', course: '', message: defaultMessage || '' })
        setTimeout(() => {
          onClose()
          setSubmitMessage({ type: '', text: '' })
        }, 3000)
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-white/90 text-sm">We're here to help you succeed</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 overflow-y-auto flex-1">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3.5 pl-12 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 bg-gray-50 focus:bg-white appearance-none"
                >
                ...
                <BookOpen className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400 pointer-events-none" />
            ...
            <button
              ...
              onClick={() => {
                onClose()
                openWhatsApp(formData.message || 'Hello! I would like to contact you.')
              }}
